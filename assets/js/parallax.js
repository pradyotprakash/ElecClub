...
var parallaxPage = function (name, pageHtml) {
    return {
            ...
            if (!parallax.sliding) {
                ...
                if (parallax.current !== this) {
                    ...
                    this.slide({ left: 0, top: 0 }, function () {
                        ...
                        if (typeof thisPage.loaded === 'function') {
                            thisPage.loaded();
                        }
                    });
        ...
        makeFirst: function (newLocation) {
            if (this !== parallax.current) {
                if (typeof this.pageLoading === 'function') { this.pageLoading(); }
                ...
                if (typeof this.pageLoaded === 'function') { this.pageLoaded(); }
            }
        },
